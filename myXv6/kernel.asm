...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 3b 7c 10 80 	movl   $0x80107c3b,(%esp)
...
80102088:	68 22 7a 10 80       	push   $0x80107a22
...
found:
  p->state = EMBRYO;
  p->pid = nextpid++;
801037e6:	a1 08 a0 10 80       	mov    0x8010a008,%eax
...
801037ee:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->tickets = 1;
801037f5:	c7 43 7c 01 00 00 00 	movl   $0x1,0x7c(%ebx)
  p->pid = nextpid++;
...
80103802:	68 20 1d 11 80       	push   $0x80111d20
  p->pid = nextpid++;
80103807:	89 15 08 a0 10 80    	mov    %edx,0x8010a008
  release(&ptable.lock);
8010380d:	e8 2e 0e 00 00       	call   80104640 <release>
...
8010382f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103832:	c7 40 14 8f 59 10 80 	movl   $0x8010598f,0x14(%eax)
  p->context = (struct context*)sp;
...
80103841:	e8 1a 0f 00 00       	call   80104760 <memset>
...
8010386a:	e8 d1 0d 00 00       	call   80104640 <release>
}
...
8010389b:	e8 a0 0d 00 00       	call   80104640 <release>
...
801038e6:	68 20 78 10 80       	push   $0x80107820
...
801039c3:	e8 b8 35 00 00       	call   80106f80 <setupkvm>
801039c8:	89 43 04             	mov    %eax,0x4(%ebx)
801039cb:	85 c0                	test   %eax,%eax
801039cd:	0f 84 c4 00 00 00    	je     80103a97 <userinit+0xe7>
...
801039e1:	e8 4a 32 00 00       	call   80106c30 <inituvm>
...
80103a4a:	8d 43 6c             	lea    0x6c(%ebx),%eax
  p->tickets = 1;
80103a4d:	c7 43 7c 01 00 00 00 	movl   $0x1,0x7c(%ebx)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a54:	6a 10                	push   $0x10
80103a56:	68 50 78 10 80       	push   $0x80107850
80103a5b:	50                   	push   %eax
80103a5c:	e8 bf 0e 00 00       	call   80104920 <safestrcpy>
  p->cwd = namei("/");
80103a61:	c7 04 24 59 78 10 80 	movl   $0x80107859,(%esp)
80103a68:	e8 33 e6 ff ff       	call   801020a0 <namei>
80103a6d:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a70:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103a77:	e8 24 0c 00 00       	call   801046a0 <acquire>
  p->state = RUNNABLE;
80103a7c:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a83:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103a8a:	e8 b1 0b 00 00       	call   80104640 <release>
}
...
80103a9a:	68 37 78 10 80       	push   $0x80107837
80103a9f:	e8 dc c8 ff ff       	call   80100380 <panic>
...
80103ab8:	e8 93 0a 00 00       	call   80104550 <pushcli>
  c = mycpu();
80103abd:	e8 3e fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
...
80103adb:	e8 40 30 00 00       	call   80106b20 <switchuvm>
  return 0;
...
80103afa:	e8 a1 32 00 00       	call   80106da0 <allocuvm>
...
80103b1a:	e8 b1 33 00 00       	call   80106ed0 <deallocuvm>
...
80103bc9:	e8 82 db ff ff       	call   80101750 <idup>
80103bce:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bd1:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103bd4:	89 47 68             	mov    %eax,0x68(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bd7:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103bda:	6a 10                	push   $0x10
80103bdc:	50                   	push   %eax
80103bdd:	8d 47 6c             	lea    0x6c(%edi),%eax
80103be0:	50                   	push   %eax
80103be1:	e8 3a 0d 00 00       	call   80104920 <safestrcpy>
  pid = np->pid;
80103be6:	8b 77 10             	mov    0x10(%edi),%esi
  acquire(&ptable.lock);
80103be9:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103bf0:	e8 ab 0a 00 00       	call   801046a0 <acquire>
  np->tickets = curproc->tickets;
80103bf5:	8b 43 7c             	mov    0x7c(%ebx),%eax
  np->state = RUNNABLE;
80103bf8:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  np->tickets = curproc->tickets;
80103bff:	89 47 7c             	mov    %eax,0x7c(%edi)
  release(&ptable.lock);
80103c02:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103c09:	e8 32 0a 00 00       	call   80104640 <release>
  return pid;
...
80103c1a:	c3                   	ret    
    return -1;
80103c1b:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103c20:	eb ef                	jmp    80103c11 <fork+0xe1>
    kfree(np->kstack);
...
80103c28:	be ff ff ff ff       	mov    $0xffffffff,%esi
    kfree(np->kstack);
80103c2d:	ff 73 08             	pushl  0x8(%ebx)
80103c30:	e8 8b e8 ff ff       	call   801024c0 <kfree>
    np->kstack = 0;
80103c35:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    return -1;
80103c3c:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103c3f:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103c46:	eb c9                	jmp    80103c11 <fork+0xe1>
80103c48:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103c4f:	90                   	nop

80103c50 <random>:
  next = next * 1103515245 + 12345;
80103c50:	69 05 04 a0 10 80 6d 	imul   $0x41c64e6d,0x8010a004,%eax
80103c57:	4e c6 41 
int random(int max) {
...
80103c5b:	31 d2                	xor    %edx,%edx
  next = next * 1103515245 + 12345;
80103c5d:	05 39 30 00 00       	add    $0x3039,%eax
int random(int max) {
80103c62:	89 e5                	mov    %esp,%ebp
  next = next * 1103515245 + 12345;
80103c64:	a3 04 a0 10 80       	mov    %eax,0x8010a004
  return (unsigned)(next / 65536) % max;
80103c69:	c1 e8 10             	shr    $0x10,%eax
80103c6c:	f7 75 08             	divl   0x8(%ebp)
}
80103c6f:	5d                   	pop    %ebp
80103c70:	89 d0                	mov    %edx,%eax
80103c72:	c3                   	ret    
...
80103c85:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103c88:	83 ec 0c             	sub    $0xc,%esp
80103c8b:	68 20 1d 11 80       	push   $0x80111d20
80103c90:	e8 0b 0a 00 00       	call   801046a0 <acquire>
  pushcli();
80103c95:	e8 b6 08 00 00       	call   80104550 <pushcli>
  c = mycpu();
80103c9a:	e8 61 fc ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103c9f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ca5:	e8 f6 08 00 00       	call   801045a0 <popcli>
  if (n < 1) {
80103caa:	83 c4 10             	add    $0x10,%esp
80103cad:	85 db                	test   %ebx,%ebx
80103caf:	7e 1c                	jle    80103ccd <settickets+0x4d>
  release(&ptable.lock);
80103cb1:	83 ec 0c             	sub    $0xc,%esp
  p->tickets = n;
80103cb4:	89 5e 7c             	mov    %ebx,0x7c(%esi)
  release(&ptable.lock);
80103cb7:	68 20 1d 11 80       	push   $0x80111d20
80103cbc:	e8 7f 09 00 00       	call   80104640 <release>
  return 0;
80103cc1:	83 c4 10             	add    $0x10,%esp
80103cc4:	31 c0                	xor    %eax,%eax
}
...
80103cd0:	68 20 1d 11 80       	push   $0x80111d20
80103cd5:	e8 66 09 00 00       	call   80104640 <release>
    return -1;
80103cda:	83 c4 10             	add    $0x10,%esp
80103cdd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ce2:	eb e2                	jmp    80103cc6 <settickets+0x46>
80103ce4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80103cf6:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103cf9:	e8 02 fc ff ff       	call   80103900 <mycpu>
  c->proc = 0;
...
80103d08:	89 c3                	mov    %eax,%ebx
  c->proc = 0;
80103d0a:	8d 70 04             	lea    0x4(%eax),%esi
80103d0d:	8d 76 00             	lea    0x0(%esi),%esi
  asm volatile("sti");
80103d10:	fb                   	sti    
    acquire(&ptable.lock);
80103d11:	83 ec 0c             	sub    $0xc,%esp
80103d14:	68 20 1d 11 80       	push   $0x80111d20
80103d19:	e8 82 09 00 00       	call   801046a0 <acquire>
80103d1e:	83 c4 10             	add    $0x10,%esp
    int total_tickets = 0;
80103d21:	31 c9                	xor    %ecx,%ecx
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d23:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
...
80103d36:	03 48 7c             	add    0x7c(%eax),%ecx
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d39:	83 e8 80             	sub    $0xffffff80,%eax
80103d3c:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103d41:	75 ed                	jne    80103d30 <scheduler+0x40>
    if (total_tickets > 0) {
80103d43:	85 c9                	test   %ecx,%ecx
80103d45:	7e 74                	jle    80103dbb <scheduler+0xcb>
  next = next * 1103515245 + 12345;
80103d47:	69 05 04 a0 10 80 6d 	imul   $0x41c64e6d,0x8010a004,%eax
80103d4e:	4e c6 41 
  return (unsigned)(next / 65536) % max;
80103d51:	31 d2                	xor    %edx,%edx
      for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d53:	bf 54 1d 11 80       	mov    $0x80111d54,%edi
  next = next * 1103515245 + 12345;
80103d58:	05 39 30 00 00       	add    $0x3039,%eax
80103d5d:	a3 04 a0 10 80       	mov    %eax,0x8010a004
  return (unsigned)(next / 65536) % max;
80103d62:	c1 e8 10             	shr    $0x10,%eax
80103d65:	f7 f1                	div    %ecx
      int current_ticket = 0;
80103d67:	31 c0                	xor    %eax,%eax
80103d69:	eb 10                	jmp    80103d7b <scheduler+0x8b>
80103d6b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d6f:	90                   	nop
      for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d70:	83 ef 80             	sub    $0xffffff80,%edi
80103d73:	81 ff 54 3d 11 80    	cmp    $0x80113d54,%edi
80103d79:	74 0d                	je     80103d88 <scheduler+0x98>
        if (p->state == RUNNABLE) {
80103d7b:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103d7f:	75 ef                	jne    80103d70 <scheduler+0x80>
          current_ticket += p->tickets;
80103d81:	03 47 7c             	add    0x7c(%edi),%eax
          if (current_ticket > winning_ticket) {
80103d84:	39 d0                	cmp    %edx,%eax
80103d86:	7e e8                	jle    80103d70 <scheduler+0x80>
      switchuvm(p);
80103d88:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103d8b:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
80103d91:	57                   	push   %edi
80103d92:	e8 89 2d 00 00       	call   80106b20 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103d97:	58                   	pop    %eax
80103d98:	5a                   	pop    %edx
80103d99:	ff 77 1c             	pushl  0x1c(%edi)
80103d9c:	56                   	push   %esi
      p->state = RUNNING;
80103d9d:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p->context);
80103da4:	e8 d2 0b 00 00       	call   8010497b <swtch>
      switchkvm();
80103da9:	e8 62 2d 00 00       	call   80106b10 <switchkvm>
      c->proc = 0;
80103dae:	83 c4 10             	add    $0x10,%esp
80103db1:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103db8:	00 00 00 
    release(&ptable.lock);
80103dbb:	83 ec 0c             	sub    $0xc,%esp
80103dbe:	68 20 1d 11 80       	push   $0x80111d20
80103dc3:	e8 78 08 00 00       	call   80104640 <release>
  for(;;){
80103dc8:	83 c4 10             	add    $0x10,%esp
80103dcb:	e9 40 ff ff ff       	jmp    80103d10 <scheduler+0x20>
...
80103dd4:	53                   	push   %ebx
  pushcli();
80103dd5:	e8 76 07 00 00       	call   80104550 <pushcli>
  c = mycpu();
80103dda:	e8 21 fb ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ddf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103de5:	e8 b6 07 00 00       	call   801045a0 <popcli>
  if(!holding(&ptable.lock))
80103dea:	83 ec 0c             	sub    $0xc,%esp
80103ded:	68 20 1d 11 80       	push   $0x80111d20
80103df2:	e8 09 08 00 00       	call   80104600 <holding>
...
80103e21:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e27:	e8 d4 fa ff ff       	call   80103900 <mycpu>
80103e2c:	83 ec 08             	sub    $0x8,%esp
80103e2f:	ff 70 04             	pushl  0x4(%eax)
80103e32:	53                   	push   %ebx
80103e33:	e8 43 0b 00 00       	call   8010497b <swtch>
  mycpu()->intena = intena;
80103e38:	e8 c3 fa ff ff       	call   80103900 <mycpu>
}
...
80103e96:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103e99:	e8 e2 fa ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
...
80103ec2:	e8 29 d0 ff ff       	call   80100ef0 <fileclose>
      curproc->ofile[fd] = 0;
...
80103ed5:	75 e1                	jne    80103eb8 <exit+0x28>
  begin_op();
80103ed7:	e8 84 ee ff ff       	call   80102d60 <begin_op>
  iput(curproc->cwd);
80103edc:	83 ec 0c             	sub    $0xc,%esp
80103edf:	ff 73 68             	pushl  0x68(%ebx)
80103ee2:	e8 c9 d9 ff ff       	call   801018b0 <iput>
  end_op();
80103ee7:	e8 e4 ee ff ff       	call   80102dd0 <end_op>
  curproc->cwd = 0;
80103eec:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103ef3:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103efa:	e8 a1 07 00 00       	call   801046a0 <acquire>
...
80103f13:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
...
80103f2f:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103f34:	75 e4                	jne    80103f1a <exit+0x8a>
      p->parent = initproc;
80103f36:	8b 0d 54 3d 11 80    	mov    0x80113d54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103f47:	90                   	nop
80103f48:	83 ea 80             	sub    $0xffffff80,%edx
80103f4b:	81 fa 54 3d 11 80    	cmp    $0x80113d54,%edx
...
80103f73:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
...
80103f9d:	68 a8 78 10 80       	push   $0x801078a8
80103fa2:	e8 d9 c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103fa7:	83 ec 0c             	sub    $0xc,%esp
80103faa:	68 9b 78 10 80       	push   $0x8010789b
...
80103fc4:	53                   	push   %ebx
  pushcli();
80103fc5:	e8 86 05 00 00       	call   80104550 <pushcli>
  c = mycpu();
...
80103fe2:	e8 b9 06 00 00       	call   801046a0 <acquire>
...
80103ffb:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
...
80104011:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104016:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
...
8010402b:	0f 85 95 00 00 00    	jne    801040c6 <wait+0x106>
  pushcli();
80104031:	e8 1a 05 00 00       	call   80104550 <pushcli>
  c = mycpu();
80104036:	e8 c5 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010403b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104041:	e8 5a 05 00 00       	call   801045a0 <popcli>
  if(p == 0)
...
8010407e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104085:	5a                   	pop    %edx
80104086:	ff 73 04             	pushl  0x4(%ebx)
80104089:	e8 72 2e 00 00       	call   80106f00 <freevm>
        p->pid = 0;
...
801040b5:	e8 86 05 00 00       	call   80104640 <release>
        return pid;
...
801040fc:	e8 9f 05 00 00       	call   801046a0 <acquire>
  pushcli();
80104101:	e8 4a 04 00 00       	call   80104550 <pushcli>
  c = mycpu();
80104106:	e8 f5 f7 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010410b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104111:	e8 8a 04 00 00       	call   801045a0 <popcli>
...
80104129:	e8 12 05 00 00       	call   80104640 <release>
}
...
8010414c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010414f:	e8 fc 03 00 00       	call   80104550 <pushcli>
  c = mycpu();
80104154:	e8 a7 f7 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104159:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010415f:	e8 3c 04 00 00       	call   801045a0 <popcli>
  if(p == 0)
...
80104180:	e8 1b 05 00 00       	call   801046a0 <acquire>
    release(lk);
80104185:	89 34 24             	mov    %esi,(%esp)
80104188:	e8 b3 04 00 00       	call   80104640 <release>
  p->chan = chan;
...
801041aa:	e8 91 04 00 00       	call   80104640 <release>
    acquire(lk);
...
801041bb:	5d                   	pop    %ebp
    acquire(lk);
801041bc:	e9 df 04 00 00       	jmp    801046a0 <acquire>
...
801041e9:	68 ba 78 10 80       	push   $0x801078ba
801041ee:	e8 8d c1 ff ff       	call   80100380 <panic>
    panic("sleep");
801041f3:	83 ec 0c             	sub    $0xc,%esp
801041f6:	68 b4 78 10 80       	push   $0x801078b4
...
8010420f:	e8 8c 04 00 00       	call   801046a0 <acquire>
...
80104223:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
...
80104235:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010423c:	83 e8 80             	sub    $0xffffff80,%eax
8010423f:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
...
80104250:	c9                   	leave  
  release(&ptable.lock);
80104251:	e9 ea 03 00 00       	jmp    80104640 <release>
...
8010426f:	e8 2c 04 00 00       	call   801046a0 <acquire>
...
80104283:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
...
801042ab:	e8 90 03 00 00       	call   80104640 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801042c8:	e8 73 03 00 00       	call   80104640 <release>
}
...
801042fb:	68 3b 7c 10 80       	push   $0x80107c3b
80104300:	e8 9b c3 ff ff       	call   801006a0 <cprintf>
80104305:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104308:	83 eb 80             	sub    $0xffffff80,%ebx
8010430b:	81 fb c0 3d 11 80    	cmp    $0x80113dc0,%ebx
...
8010431c:	74 ea                	je     80104308 <procdump+0x28>
      state = "???";
8010431e:	ba cb 78 10 80       	mov    $0x801078cb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104323:	83 f8 05             	cmp    $0x5,%eax
80104326:	77 11                	ja     80104339 <procdump+0x59>
80104328:	8b 14 85 2c 79 10 80 	mov    -0x7fef86d4(,%eax,4),%edx
      state = "???";
8010432f:	b8 cb 78 10 80       	mov    $0x801078cb,%eax
...
8010433e:	68 cf 78 10 80       	push   $0x801078cf
...
8010437d:	68 21 73 10 80       	push   $0x80107321
...
801043aa:	68 44 79 10 80       	push   $0x80107944
...
801045e5:	68 4f 79 10 80       	push   $0x8010794f
801045ea:	e8 91 bd ff ff       	call   80100380 <panic>
    panic("popcli");
801045ef:	83 ec 0c             	sub    $0xc,%esp
801045f2:	68 66 79 10 80       	push   $0x80107966
...
8010465b:	68 6d 79 10 80       	push   $0x8010796d
...
80104750:	68 75 79 10 80       	push   $0x80107975
...
80104b77:	83 fa 15             	cmp    $0x15,%edx
80104b7a:	77 24                	ja     80104ba0 <syscall+0x40>
80104b7c:	8b 14 85 a0 79 10 80 	mov    -0x7fef8660(,%eax,4),%edx
...
80104ba8:	68 7d 79 10 80       	push   $0x8010797d
...
80104d04:	68 18 7a 10 80       	push   $0x80107a18
...
80104d1c:	68 17 7a 10 80       	push   $0x80107a17
...
80104d31:	68 0b 7a 10 80       	push   $0x80107a0b
...
80104d4f:	68 1a 7a 10 80       	push   $0x80107a1a
80104d54:	e8 27 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d59:	83 ec 0c             	sub    $0xc,%esp
80104d5c:	68 fc 79 10 80       	push   $0x801079fc
...
80104e4d:	ff 75 f0             	pushl  -0x10(%ebp)
80104e50:	ff 75 f4             	pushl  -0xc(%ebp)
...
80104ecd:	ff 75 f0             	pushl  -0x10(%ebp)
...
8010515d:	58                   	pop    %eax
8010515e:	5a                   	pop    %edx
8010515f:	68 18 7a 10 80       	push   $0x80107a18
...
80105178:	68 17 7a 10 80       	push   $0x80107a17
...
801051dd:	ff 75 b4             	pushl  -0x4c(%ebp)
...
801051ff:	ff 75 b4             	pushl  -0x4c(%ebp)
...
80105273:	ff 75 b4             	pushl  -0x4c(%ebp)
...
8010569f:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
...
{
  return fork();
80105790:	e9 9b e3 ff ff       	jmp    80103b30 <fork>
...
801057a3:	83 ec 08             	sub    $0x8,%esp
  exit();
801057a6:	e8 e5 e6 ff ff       	call   80103e90 <exit>
...
{
  return wait();
801057b0:	e9 0b e8 ff ff       	jmp    80103fc0 <wait>
...
801057cc:	e8 4f f2 ff ff       	call   80104a20 <argint>
...
801057de:	e8 7d ea ff ff       	call   80104260 <kill>
...
80105803:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105806:	e8 75 e1 ff ff       	call   80103980 <myproc>
...
80105836:	e8 75 e2 ff ff       	call   80103ab0 <growproc>
...
8010586d:	e8 ae f1 ff ff       	call   80104a20 <argint>
...
80105880:	68 80 3d 11 80       	push   $0x80113d80
80105885:	e8 16 ee ff ff       	call   801046a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010588a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010588d:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
...
801058a3:	68 80 3d 11 80       	push   $0x80113d80
801058a8:	68 60 3d 11 80       	push   $0x80113d60
801058ad:	e8 8e e8 ff ff       	call   80104140 <sleep>
  while(ticks - ticks0 < n){
801058b2:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
801058bf:	73 2f                	jae    801058f0 <sys_sleep+0x90>
    if(myproc()->killed){
801058c1:	e8 ba e0 ff ff       	call   80103980 <myproc>
...
801058d5:	e8 66 ed ff ff       	call   80104640 <release>
  }
  release(&tickslock);
  return 0;
}
...
801058f8:	e8 43 ed ff ff       	call   80104640 <release>
  return 0;
...
8010594c:	e8 cf f0 ff ff       	call   80104a20 <argint>
80105951:	83 c4 10             	add    $0x10,%esp
80105954:	85 c0                	test   %eax,%eax
80105956:	78 18                	js     80105970 <sys_settickets+0x30>
    return -1;
  return settickets(n);
80105958:	83 ec 0c             	sub    $0xc,%esp
8010595b:	ff 75 f4             	pushl  -0xc(%ebp)
8010595e:	e8 1d e3 ff ff       	call   80103c80 <settickets>
...
801059b7:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
801059be:	08 00 00 8e 
801059c2:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
801059c9:	80 
801059ca:	c1 ea 10             	shr    $0x10,%edx
801059cd:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
801059d4:	80 
  for(i = 0; i < 256; i++)
...
801059e7:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
801059ee:	00 00 ef 
  initlock(&tickslock, "time");
801059f1:	68 5d 7a 10 80       	push   $0x80107a5d
801059f6:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059fb:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105a01:	c1 e8 10             	shr    $0x10,%eax
80105a04:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
...
80105a2b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a2f:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105a74:	ff 24 85 04 7b 10 80 	jmp    *-0x7fef84fc(,%eax,4)
...
80105b39:	e8 42 de ff ff       	call   80103980 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105b55:	68 c0 7a 10 80       	push   $0x80107ac0
80105b5a:	e8 41 ab ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105b5f:	83 c4 20             	add    $0x20,%esp
80105b62:	e8 19 de ff ff       	call   80103980 <myproc>
80105b67:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b6e:	e8 0d de ff ff       	call   80103980 <myproc>
...
80105b84:	0f 85 3e ff ff ff    	jne    80105ac8 <trap+0x78>
    yield();
80105b8a:	e8 61 e5 ff ff       	call   801040f0 <yield>
...
80105b9f:	e8 bc dd ff ff       	call   80103960 <cpuid>
80105ba4:	57                   	push   %edi
80105ba5:	56                   	push   %esi
80105ba6:	50                   	push   %eax
80105ba7:	68 68 7a 10 80       	push   $0x80107a68
...
80105be5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105be8:	e8 73 ef ff ff       	call   80104b60 <syscall>
    if(myproc()->killed)
80105bed:	e8 8e dd ff ff       	call   80103980 <myproc>
...
80105c03:	5d                   	pop    %ebp
      exit();
80105c04:	e9 87 e2 ff ff       	jmp    80103e90 <exit>
...
80105c35:	e8 d6 cc ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c3a:	e8 41 dd ff ff       	call   80103980 <myproc>
...
80105c4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105c50:	e8 0b dd ff ff       	call   80103960 <cpuid>
80105c55:	85 c0                	test   %eax,%eax
80105c57:	0f 85 28 fe ff ff    	jne    80105a85 <trap+0x35>
      acquire(&tickslock);
80105c5d:	83 ec 0c             	sub    $0xc,%esp
80105c60:	68 80 3d 11 80       	push   $0x80113d80
80105c65:	e8 36 ea ff ff       	call   801046a0 <acquire>
      wakeup(&ticks);
80105c6a:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105c71:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105c78:	e8 83 e5 ff ff       	call   80104200 <wakeup>
      release(&tickslock);
80105c7d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105c84:	e8 b7 e9 ff ff       	call   80104640 <release>
...
80105cc3:	68 8c 7a 10 80       	push   $0x80107a8c
80105cc8:	e8 d3 a9 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105ccd:	83 c4 14             	add    $0x14,%esp
80105cd0:	68 62 7a 10 80       	push   $0x80107a62
...
80105d67:	74 78                	je     80105de1 <uartinit+0xd1>
  uart = 1;
80105d69:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105d70:	00 00 00 
...
80105d7c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d7f:	bf 84 7b 10 80       	mov    $0x80107b84,%edi
...
80105d99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105da0:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105df0 <uartputc>:
  if(!uart)
80105df0:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105e67:	6a 00                	push   $0x0
  jmp alltraps
80105e69:	e9 09 fb ff ff       	jmp    80105977 <alltraps>
...
80105e70:	6a 01                	push   $0x1
  jmp alltraps
80105e72:	e9 00 fb ff ff       	jmp    80105977 <alltraps>
...
80105e79:	6a 02                	push   $0x2
  jmp alltraps
80105e7b:	e9 f7 fa ff ff       	jmp    80105977 <alltraps>
...
80105e82:	6a 03                	push   $0x3
  jmp alltraps
80105e84:	e9 ee fa ff ff       	jmp    80105977 <alltraps>
...
80105e8b:	6a 04                	push   $0x4
  jmp alltraps
80105e8d:	e9 e5 fa ff ff       	jmp    80105977 <alltraps>
...
80105e9d:	6a 06                	push   $0x6
  jmp alltraps
80105e9f:	e9 d3 fa ff ff       	jmp    80105977 <alltraps>
...
80105ea6:	6a 07                	push   $0x7
  jmp alltraps
80105ea8:	e9 ca fa ff ff       	jmp    80105977 <alltraps>
...
80105ead:	6a 08                	push   $0x8
  jmp alltraps
80105eaf:	e9 c3 fa ff ff       	jmp    80105977 <alltraps>
...
80105eb6:	6a 09                	push   $0x9
  jmp alltraps
80105eb8:	e9 ba fa ff ff       	jmp    80105977 <alltraps>
...
80105ebd:	6a 0a                	push   $0xa
  jmp alltraps
80105ebf:	e9 b3 fa ff ff       	jmp    80105977 <alltraps>
...
80105ec4:	6a 0b                	push   $0xb
  jmp alltraps
80105ec6:	e9 ac fa ff ff       	jmp    80105977 <alltraps>
...
80105ed2:	6a 0d                	push   $0xd
  jmp alltraps
80105ed4:	e9 9e fa ff ff       	jmp    80105977 <alltraps>
...
80105ed9:	6a 0e                	push   $0xe
  jmp alltraps
80105edb:	e9 97 fa ff ff       	jmp    80105977 <alltraps>
...
80105ee2:	6a 0f                	push   $0xf
  jmp alltraps
80105ee4:	e9 8e fa ff ff       	jmp    80105977 <alltraps>
...
80105eeb:	6a 10                	push   $0x10
  jmp alltraps
80105eed:	e9 85 fa ff ff       	jmp    80105977 <alltraps>
...
80105ef2:	6a 11                	push   $0x11
  jmp alltraps
80105ef4:	e9 7e fa ff ff       	jmp    80105977 <alltraps>
...
80105efb:	6a 12                	push   $0x12
  jmp alltraps
80105efd:	e9 75 fa ff ff       	jmp    80105977 <alltraps>
...
80105f04:	6a 13                	push   $0x13
  jmp alltraps
80105f06:	e9 6c fa ff ff       	jmp    80105977 <alltraps>
...
80105f0d:	6a 14                	push   $0x14
  jmp alltraps
80105f0f:	e9 63 fa ff ff       	jmp    80105977 <alltraps>
...
80105f16:	6a 15                	push   $0x15
  jmp alltraps
80105f18:	e9 5a fa ff ff       	jmp    80105977 <alltraps>
...
80105f1f:	6a 16                	push   $0x16
  jmp alltraps
80105f21:	e9 51 fa ff ff       	jmp    80105977 <alltraps>
...
80105f28:	6a 17                	push   $0x17
  jmp alltraps
80105f2a:	e9 48 fa ff ff       	jmp    80105977 <alltraps>
...
80105f31:	6a 18                	push   $0x18
  jmp alltraps
80105f33:	e9 3f fa ff ff       	jmp    80105977 <alltraps>
...
80105f3a:	6a 19                	push   $0x19
  jmp alltraps
80105f3c:	e9 36 fa ff ff       	jmp    80105977 <alltraps>
...
80105f43:	6a 1a                	push   $0x1a
  jmp alltraps
80105f45:	e9 2d fa ff ff       	jmp    80105977 <alltraps>
...
80105f4c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f4e:	e9 24 fa ff ff       	jmp    80105977 <alltraps>
...
80105f55:	6a 1c                	push   $0x1c
  jmp alltraps
80105f57:	e9 1b fa ff ff       	jmp    80105977 <alltraps>
...
80105f5e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f60:	e9 12 fa ff ff       	jmp    80105977 <alltraps>
...
80105f67:	6a 1e                	push   $0x1e
  jmp alltraps
80105f69:	e9 09 fa ff ff       	jmp    80105977 <alltraps>
...
80105f70:	6a 1f                	push   $0x1f
  jmp alltraps
80105f72:	e9 00 fa ff ff       	jmp    80105977 <alltraps>
...
80105f79:	6a 20                	push   $0x20
  jmp alltraps
80105f7b:	e9 f7 f9 ff ff       	jmp    80105977 <alltraps>
...
80105f82:	6a 21                	push   $0x21
  jmp alltraps
80105f84:	e9 ee f9 ff ff       	jmp    80105977 <alltraps>
...
80105f8b:	6a 22                	push   $0x22
  jmp alltraps
80105f8d:	e9 e5 f9 ff ff       	jmp    80105977 <alltraps>
...
80105f94:	6a 23                	push   $0x23
  jmp alltraps
80105f96:	e9 dc f9 ff ff       	jmp    80105977 <alltraps>
...
80105f9d:	6a 24                	push   $0x24
  jmp alltraps
80105f9f:	e9 d3 f9 ff ff       	jmp    80105977 <alltraps>
...
80105fa6:	6a 25                	push   $0x25
  jmp alltraps
80105fa8:	e9 ca f9 ff ff       	jmp    80105977 <alltraps>
...
80105faf:	6a 26                	push   $0x26
  jmp alltraps
80105fb1:	e9 c1 f9 ff ff       	jmp    80105977 <alltraps>
...
80105fb8:	6a 27                	push   $0x27
  jmp alltraps
80105fba:	e9 b8 f9 ff ff       	jmp    80105977 <alltraps>
...
80105fc1:	6a 28                	push   $0x28
  jmp alltraps
80105fc3:	e9 af f9 ff ff       	jmp    80105977 <alltraps>
...
80105fca:	6a 29                	push   $0x29
  jmp alltraps
80105fcc:	e9 a6 f9 ff ff       	jmp    80105977 <alltraps>
...
80105fd3:	6a 2a                	push   $0x2a
  jmp alltraps
80105fd5:	e9 9d f9 ff ff       	jmp    80105977 <alltraps>
...
80105fdc:	6a 2b                	push   $0x2b
  jmp alltraps
80105fde:	e9 94 f9 ff ff       	jmp    80105977 <alltraps>
...
80105fe5:	6a 2c                	push   $0x2c
  jmp alltraps
80105fe7:	e9 8b f9 ff ff       	jmp    80105977 <alltraps>
...
80105fee:	6a 2d                	push   $0x2d
  jmp alltraps
80105ff0:	e9 82 f9 ff ff       	jmp    80105977 <alltraps>
...
80105ff7:	6a 2e                	push   $0x2e
  jmp alltraps
80105ff9:	e9 79 f9 ff ff       	jmp    80105977 <alltraps>
...
80106000:	6a 2f                	push   $0x2f
  jmp alltraps
80106002:	e9 70 f9 ff ff       	jmp    80105977 <alltraps>
...
80106009:	6a 30                	push   $0x30
  jmp alltraps
8010600b:	e9 67 f9 ff ff       	jmp    80105977 <alltraps>
...
80106012:	6a 31                	push   $0x31
  jmp alltraps
80106014:	e9 5e f9 ff ff       	jmp    80105977 <alltraps>
...
8010601b:	6a 32                	push   $0x32
  jmp alltraps
8010601d:	e9 55 f9 ff ff       	jmp    80105977 <alltraps>
...
80106024:	6a 33                	push   $0x33
  jmp alltraps
80106026:	e9 4c f9 ff ff       	jmp    80105977 <alltraps>
...
8010602d:	6a 34                	push   $0x34
  jmp alltraps
8010602f:	e9 43 f9 ff ff       	jmp    80105977 <alltraps>
...
80106036:	6a 35                	push   $0x35
  jmp alltraps
80106038:	e9 3a f9 ff ff       	jmp    80105977 <alltraps>
...
8010603f:	6a 36                	push   $0x36
  jmp alltraps
80106041:	e9 31 f9 ff ff       	jmp    80105977 <alltraps>
...
80106048:	6a 37                	push   $0x37
  jmp alltraps
8010604a:	e9 28 f9 ff ff       	jmp    80105977 <alltraps>
...
80106051:	6a 38                	push   $0x38
  jmp alltraps
80106053:	e9 1f f9 ff ff       	jmp    80105977 <alltraps>
...
8010605a:	6a 39                	push   $0x39
  jmp alltraps
8010605c:	e9 16 f9 ff ff       	jmp    80105977 <alltraps>
...
80106063:	6a 3a                	push   $0x3a
  jmp alltraps
80106065:	e9 0d f9 ff ff       	jmp    80105977 <alltraps>
...
8010606c:	6a 3b                	push   $0x3b
  jmp alltraps
8010606e:	e9 04 f9 ff ff       	jmp    80105977 <alltraps>
...
80106075:	6a 3c                	push   $0x3c
  jmp alltraps
80106077:	e9 fb f8 ff ff       	jmp    80105977 <alltraps>
...
8010607e:	6a 3d                	push   $0x3d
  jmp alltraps
80106080:	e9 f2 f8 ff ff       	jmp    80105977 <alltraps>
...
80106087:	6a 3e                	push   $0x3e
  jmp alltraps
80106089:	e9 e9 f8 ff ff       	jmp    80105977 <alltraps>
...
80106090:	6a 3f                	push   $0x3f
  jmp alltraps
80106092:	e9 e0 f8 ff ff       	jmp    80105977 <alltraps>
...
80106099:	6a 40                	push   $0x40
  jmp alltraps
8010609b:	e9 d7 f8 ff ff       	jmp    80105977 <alltraps>
...
801060a2:	6a 41                	push   $0x41
  jmp alltraps
801060a4:	e9 ce f8 ff ff       	jmp    80105977 <alltraps>
...
801060ab:	6a 42                	push   $0x42
  jmp alltraps
801060ad:	e9 c5 f8 ff ff       	jmp    80105977 <alltraps>
...
801060b4:	6a 43                	push   $0x43
  jmp alltraps
801060b6:	e9 bc f8 ff ff       	jmp    80105977 <alltraps>
...
801060bd:	6a 44                	push   $0x44
  jmp alltraps
801060bf:	e9 b3 f8 ff ff       	jmp    80105977 <alltraps>
...
801060c6:	6a 45                	push   $0x45
  jmp alltraps
801060c8:	e9 aa f8 ff ff       	jmp    80105977 <alltraps>
...
801060cf:	6a 46                	push   $0x46
  jmp alltraps
801060d1:	e9 a1 f8 ff ff       	jmp    80105977 <alltraps>
...
801060d8:	6a 47                	push   $0x47
  jmp alltraps
801060da:	e9 98 f8 ff ff       	jmp    80105977 <alltraps>
...
801060e1:	6a 48                	push   $0x48
  jmp alltraps
801060e3:	e9 8f f8 ff ff       	jmp    80105977 <alltraps>
...
801060ea:	6a 49                	push   $0x49
  jmp alltraps
801060ec:	e9 86 f8 ff ff       	jmp    80105977 <alltraps>
...
801060f3:	6a 4a                	push   $0x4a
  jmp alltraps
801060f5:	e9 7d f8 ff ff       	jmp    80105977 <alltraps>
...
801060fc:	6a 4b                	push   $0x4b
  jmp alltraps
801060fe:	e9 74 f8 ff ff       	jmp    80105977 <alltraps>
...
80106105:	6a 4c                	push   $0x4c
  jmp alltraps
80106107:	e9 6b f8 ff ff       	jmp    80105977 <alltraps>
...
8010610e:	6a 4d                	push   $0x4d
  jmp alltraps
80106110:	e9 62 f8 ff ff       	jmp    80105977 <alltraps>
...
80106117:	6a 4e                	push   $0x4e
  jmp alltraps
80106119:	e9 59 f8 ff ff       	jmp    80105977 <alltraps>
...
80106120:	6a 4f                	push   $0x4f
  jmp alltraps
80106122:	e9 50 f8 ff ff       	jmp    80105977 <alltraps>
...
80106129:	6a 50                	push   $0x50
  jmp alltraps
8010612b:	e9 47 f8 ff ff       	jmp    80105977 <alltraps>
...
80106132:	6a 51                	push   $0x51
  jmp alltraps
80106134:	e9 3e f8 ff ff       	jmp    80105977 <alltraps>
...
8010613b:	6a 52                	push   $0x52
  jmp alltraps
8010613d:	e9 35 f8 ff ff       	jmp    80105977 <alltraps>
...
80106144:	6a 53                	push   $0x53
  jmp alltraps
80106146:	e9 2c f8 ff ff       	jmp    80105977 <alltraps>
...
8010614d:	6a 54                	push   $0x54
  jmp alltraps
8010614f:	e9 23 f8 ff ff       	jmp    80105977 <alltraps>
...
80106156:	6a 55                	push   $0x55
  jmp alltraps
80106158:	e9 1a f8 ff ff       	jmp    80105977 <alltraps>
...
8010615f:	6a 56                	push   $0x56
  jmp alltraps
80106161:	e9 11 f8 ff ff       	jmp    80105977 <alltraps>
...
80106168:	6a 57                	push   $0x57
  jmp alltraps
8010616a:	e9 08 f8 ff ff       	jmp    80105977 <alltraps>
...
80106171:	6a 58                	push   $0x58
  jmp alltraps
80106173:	e9 ff f7 ff ff       	jmp    80105977 <alltraps>
...
8010617a:	6a 59                	push   $0x59
  jmp alltraps
8010617c:	e9 f6 f7 ff ff       	jmp    80105977 <alltraps>
...
80106183:	6a 5a                	push   $0x5a
  jmp alltraps
80106185:	e9 ed f7 ff ff       	jmp    80105977 <alltraps>
...
8010618c:	6a 5b                	push   $0x5b
  jmp alltraps
8010618e:	e9 e4 f7 ff ff       	jmp    80105977 <alltraps>
...
80106195:	6a 5c                	push   $0x5c
  jmp alltraps
80106197:	e9 db f7 ff ff       	jmp    80105977 <alltraps>
...
8010619e:	6a 5d                	push   $0x5d
  jmp alltraps
801061a0:	e9 d2 f7 ff ff       	jmp    80105977 <alltraps>
...
801061a7:	6a 5e                	push   $0x5e
  jmp alltraps
801061a9:	e9 c9 f7 ff ff       	jmp    80105977 <alltraps>
...
801061b0:	6a 5f                	push   $0x5f
  jmp alltraps
801061b2:	e9 c0 f7 ff ff       	jmp    80105977 <alltraps>
...
801061b9:	6a 60                	push   $0x60
  jmp alltraps
801061bb:	e9 b7 f7 ff ff       	jmp    80105977 <alltraps>
...
801061c2:	6a 61                	push   $0x61
  jmp alltraps
801061c4:	e9 ae f7 ff ff       	jmp    80105977 <alltraps>
...
801061cb:	6a 62                	push   $0x62
  jmp alltraps
801061cd:	e9 a5 f7 ff ff       	jmp    80105977 <alltraps>
...
801061d4:	6a 63                	push   $0x63
  jmp alltraps
801061d6:	e9 9c f7 ff ff       	jmp    80105977 <alltraps>
...
801061dd:	6a 64                	push   $0x64
  jmp alltraps
801061df:	e9 93 f7 ff ff       	jmp    80105977 <alltraps>
...
801061e6:	6a 65                	push   $0x65
  jmp alltraps
801061e8:	e9 8a f7 ff ff       	jmp    80105977 <alltraps>
...
801061ef:	6a 66                	push   $0x66
  jmp alltraps
801061f1:	e9 81 f7 ff ff       	jmp    80105977 <alltraps>
...
801061f8:	6a 67                	push   $0x67
  jmp alltraps
801061fa:	e9 78 f7 ff ff       	jmp    80105977 <alltraps>
...
80106201:	6a 68                	push   $0x68
  jmp alltraps
80106203:	e9 6f f7 ff ff       	jmp    80105977 <alltraps>
...
8010620a:	6a 69                	push   $0x69
  jmp alltraps
8010620c:	e9 66 f7 ff ff       	jmp    80105977 <alltraps>
...
80106213:	6a 6a                	push   $0x6a
  jmp alltraps
80106215:	e9 5d f7 ff ff       	jmp    80105977 <alltraps>
...
8010621c:	6a 6b                	push   $0x6b
  jmp alltraps
8010621e:	e9 54 f7 ff ff       	jmp    80105977 <alltraps>
...
80106225:	6a 6c                	push   $0x6c
  jmp alltraps
80106227:	e9 4b f7 ff ff       	jmp    80105977 <alltraps>
...
8010622e:	6a 6d                	push   $0x6d
  jmp alltraps
80106230:	e9 42 f7 ff ff       	jmp    80105977 <alltraps>
...
80106237:	6a 6e                	push   $0x6e
  jmp alltraps
80106239:	e9 39 f7 ff ff       	jmp    80105977 <alltraps>
...
80106240:	6a 6f                	push   $0x6f
  jmp alltraps
80106242:	e9 30 f7 ff ff       	jmp    80105977 <alltraps>
...
80106249:	6a 70                	push   $0x70
  jmp alltraps
8010624b:	e9 27 f7 ff ff       	jmp    80105977 <alltraps>
...
80106252:	6a 71                	push   $0x71
  jmp alltraps
80106254:	e9 1e f7 ff ff       	jmp    80105977 <alltraps>
...
8010625b:	6a 72                	push   $0x72
  jmp alltraps
8010625d:	e9 15 f7 ff ff       	jmp    80105977 <alltraps>
...
80106264:	6a 73                	push   $0x73
  jmp alltraps
80106266:	e9 0c f7 ff ff       	jmp    80105977 <alltraps>
...
8010626d:	6a 74                	push   $0x74
  jmp alltraps
8010626f:	e9 03 f7 ff ff       	jmp    80105977 <alltraps>
...
80106276:	6a 75                	push   $0x75
  jmp alltraps
80106278:	e9 fa f6 ff ff       	jmp    80105977 <alltraps>
...
8010627f:	6a 76                	push   $0x76
  jmp alltraps
80106281:	e9 f1 f6 ff ff       	jmp    80105977 <alltraps>
...
80106288:	6a 77                	push   $0x77
  jmp alltraps
8010628a:	e9 e8 f6 ff ff       	jmp    80105977 <alltraps>
...
80106291:	6a 78                	push   $0x78
  jmp alltraps
80106293:	e9 df f6 ff ff       	jmp    80105977 <alltraps>
...
8010629a:	6a 79                	push   $0x79
  jmp alltraps
8010629c:	e9 d6 f6 ff ff       	jmp    80105977 <alltraps>
...
801062a3:	6a 7a                	push   $0x7a
  jmp alltraps
801062a5:	e9 cd f6 ff ff       	jmp    80105977 <alltraps>
...
801062b5:	6a 7c                	push   $0x7c
  jmp alltraps
801062b7:	e9 bb f6 ff ff       	jmp    80105977 <alltraps>
...
801062be:	6a 7d                	push   $0x7d
  jmp alltraps
801062c0:	e9 b2 f6 ff ff       	jmp    80105977 <alltraps>
...
801062c7:	6a 7e                	push   $0x7e
  jmp alltraps
801062c9:	e9 a9 f6 ff ff       	jmp    80105977 <alltraps>
...
801068a9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801068ae:	e9 c4 f0 ff ff       	jmp    80105977 <alltraps>
...
801068b5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801068ba:	e9 b8 f0 ff ff       	jmp    80105977 <alltraps>
...
801068c1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801068c6:	e9 ac f0 ff ff       	jmp    80105977 <alltraps>
...
801068cd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801068d2:	e9 a0 f0 ff ff       	jmp    80105977 <alltraps>
...
80106a25:	e8 36 dd ff ff       	call   80104760 <memset>
...
80106a6d:	68 8c 7b 10 80       	push   $0x80107b8c
...
80106a83:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a86:	e8 d5 ce ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106b10:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106b44:	0f 84 c2 00 00 00    	je     80106c0c <switchuvm+0xec>
  pushcli();
80106b4a:	e8 01 da ff ff       	call   80104550 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b4f:	e8 ac cd ff ff       	call   80103900 <mycpu>
80106b54:	89 c3                	mov    %eax,%ebx
80106b56:	e8 a5 cd ff ff       	call   80103900 <mycpu>
80106b5b:	89 c7                	mov    %eax,%edi
80106b5d:	e8 9e cd ff ff       	call   80103900 <mycpu>
80106b62:	83 c7 08             	add    $0x8,%edi
80106b65:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106b68:	e8 93 cd ff ff       	call   80103900 <mycpu>
...
80106c5f:	e8 fc da ff ff       	call   80104760 <memset>
...
80106c92:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c93:	e9 68 db ff ff       	jmp    80104800 <memmove>
    panic("inituvm: more than a page");
80106c98:	83 ec 0c             	sub    $0xc,%esp
80106c9b:	68 d1 7b 10 80       	push   $0x80107bd1
...
80106d00:	68 eb 7b 10 80       	push   $0x80107beb
...
80106d88:	68 8c 7c 10 80       	push   $0x80107c8c
...
80106deb:	e8 70 d9 ff ff       	call   80104760 <memset>
...
80106e29:	68 09 7c 10 80       	push   $0x80107c09
...
80106e8b:	68 21 7c 10 80       	push   $0x80107c21
...
80106f6c:	68 3d 7c 10 80       	push   $0x80107c3d
...
80106fa0:	e8 bb d7 ff ff       	call   80104760 <memset>
...
8010700b:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010703c:	68 4e 7c 10 80       	push   $0x80107c4e
...
801070b2:	68 58 7c 10 80       	push   $0x80107c58
...
80107110:	e8 eb d6 ff ff       	call   80104800 <memmove>
...
80107187:	68 72 7c 10 80       	push   $0x80107c72
...
80107240:	e8 bb d5 ff ff       	call   80104800 <memmove>
    len -= n;
    buf += n;
